...
type CurrentWeatherDataRetriever interface {
	...
	GetByGeoCoordinates(lat, log float32) (Weather, error)
}

//JSON struct of OpenWeatherMapAPI
type Weather struct {
	Coord struct {
...
//Single point of access for the API
...
//=======================================================================Above is enough for better understanding===============================================================
